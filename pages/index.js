...
const Home = () => {
  ...
  return (
    <Fragment>
      <Head>
        <title>Sonika&apos;s Portfolio</title>
        {/* <!-- Primary Meta Tags --> */}
        <meta content="Sonika's Portfolio" name="title" />
        <meta content="Explore the best Next.js and React.js portfolio by Sonika Bharti. Featuring simple, dark and light theme designs and mobile responsiveness." name="description" />

        {/* <!-- Open Graph / Facebook --> */}
        <meta content="website" property="og:type" />
        {/* <meta content="https://shiv-s-portfolio.vercel.app" property="og:url" /> */}
        <meta content="Sonika's Portfolio" property="og:title" />
        <meta content="Explore the best Next.js and React.js portfolio by Sonika Bharti. Featuring simple, dark and light theme designs and mobile responsiveness." property="og:description" />
        ...
        <meta content="Sonika Bharti - Portfolio" property="twitter:title" />
        <meta content="Explore the best Next.js and React.js portfolio by Sonika Bharti. Featuring simple, dark and light theme designs and mobile responsiveness." property="twitter:description" />
