      ...
      <Theme>
        ...
        <div className='layoutContainer'>
          <div className='layoutBox1'>
            <h1 className='blog-heading'>History Operation</h1>
...
const Example1 = ({ myDark }) => {
  ...
  function applyOperations(operations, k) {
    let content = "";

    for (let i = 0; i < operations.length; i++) {
        const operation = operations[i];
        const [type, value] = operation.split(/:\s*/);
        if (type === "ADD") {
            content += value;
    ...
    return content.slice(-k * content.length);
}

const operations = ['ADD:hello', 'ADD:world', 'DELETE:hello'];
const k = 1;
console.log(applyOperations(operations, k)); // Output: "helloworld"
`;
